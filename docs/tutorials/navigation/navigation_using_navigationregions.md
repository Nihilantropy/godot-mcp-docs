# Using NavigationRegions {#doc_navigation_using_navigationregions}
...
override void [Ready]{#ready}() { Rid navigationServerRegionRid =
GetRid(); } }
...
[Ready]{#ready}() { Rid newRegionRid =
NavigationServer2D.RegionCreate(); Rid defaultMapRid =
...
[Ready]{#ready}() { Rid newRegionRid =
NavigationServer3D.RegionCreate(); Rid defaultMapRid =
