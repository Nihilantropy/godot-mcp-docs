# 3D navigation overview {#doc_navigation_overview_3d}
...
NavigationAgent3D [navigationAgent]{#navigationagent};

> private float [movementSpeed]{#movementspeed} = 2.0f; private Vector3
> [movementTargetPosition]{#movementtargetposition} = new Vector3(-3.0f,
> 0.0f, 2.0f);
>
