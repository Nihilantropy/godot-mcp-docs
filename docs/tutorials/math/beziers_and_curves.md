# Beziers, curves and paths {#doc_beziers_and_curves}
...
func [quadratic_bezier]{#quadratic_bezier}(p0: Vector2, p1: Vector2, p2: Vector2, t: float):
...
func [cubic_bezier]{#cubic_bezier}(p0: Vector2, p1: Vector2, p2:
Vector2, p3: Vector2, t: float):
...
func [cubic_bezier]{#cubic_bezier}(p0: Vector2, p1: Vector2, p2: Vector2, p3: Vector2, t: float):
...
:   t += delta position = [cubic_bezier]{#cubic_bezier}(p0, p1, p2, p3,
    t)
...
public override void [Process]{#process}(double delta) { [t]{#t} +=
(float)delta; Position = CubicBezier(p0, p1, p2, p3, [t]{#t}); }
::::
...
public override void [Process]{#process}(double delta) { [t]{#t} +=
(float)delta; Position = curve.SampleBaked([t]{#t} \*
curve.GetBakedLength(), true); }
::::
