...
KinematicCollision2D collision = MoveAndCollide([velocity]{#velocity} \*
(float)delta); if (collision != null) { var reflect =
collision.GetRemainder().Bounce(collision.GetNormal());
[velocity]{#velocity} =
[velocity.Bounce]{#velocity.bounce}(collision.GetNormal());
