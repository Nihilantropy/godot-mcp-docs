# Kinematic character (2D) {#doc_kinematic_character_2d}
...
override void [PhysicsProcess]{#physicsprocess}(double delta) { } }
::::
...
public partial class MyCharacterBody2D : CharacterBody2D { public
override void [PhysicsProcess]{#physicsprocess}(double delta) { // Move
down 1 pixel per physics frame MoveAndCollide(new Vector2(0, 1)); } }
::::
...
> var velocity = Velocity; velocity.Y += (float)delta \* Gravity;
> Velocity = velocity;
>
