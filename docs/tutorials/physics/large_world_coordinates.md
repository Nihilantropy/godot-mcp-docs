# Large world coordinates {#doc_large_world_coordinates}
...
- **Double-precision float range (represent all integers):** Between -9
  ...
  \[1; 2\]    \~0.0000001   \~1e-15          Precision becomes greater near 0.0
                                             (this table is abbreviated).
  ...
  \[2048;     \~0.0002      \~1e-12          Maximum *recommended*
  4096\]                                     single-precision range for a
                                             first-person 3D game without
                                             rendering artifacts or physics
                                             glitches.

  \[4096;     \~0.0005      \~1e-12          Maximum *recommended*
  8192\]                                     single-precision range for a
                                             third-person 3D game without
                                             rendering artifacts or physics
                                             glitches.
  ...
  \[16384;    \~0.0019      \~1e-11          Maximum *recommended*
  32768\]                                    single-precision range for a
                                             top-down 3D game without rendering
                                             artifacts or physics glitches.

  \[32768;    \~0.0039      \~1e-11          Maximum *recommended*
  65536\]                                    single-precision range for any 3D
                                             game. Double precision (large world
                                             coordinates) is usually required
                                             past this point.
  ...
  \> 262144   \> \~0.0313   \~1e-10          Double-precision remains far more
                            (0.0000000001)   precise than single-precision past
                                             this value.
  ----------- ------------- ---------------- ------------------------------------
...
By default, `class_float`{.interpreted-text role="ref"} is 64-bit in
...
On low-end platforms, an *origin shifting* approach can be used instead
