# Using RigidBody {#doc_rigid_body}
...
public partial class MyRigidBody3D : RigidBody3D { private float
[speed]{#speed} = 0.1f; private void LookFollow(PhysicsDirectBodyState3D
state, Transform3D currentTransform, Vector3 targetPosition) { Vector3
...
float localSpeed = Mathf.Clamp([speed]{#speed}, 0.0f,
...
> [IntegrateForces]{#integrateforces}(PhysicsDirectBodyState3D state) {
