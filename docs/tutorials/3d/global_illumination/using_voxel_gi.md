# Using Voxel global illumination {#doc_using_voxel_gi}
...
VoxelGI is only supported when using the Forward+ renderer, not the
...
- **Bias:** Optional bias added to lookups into the voxel buffer at
  runtime. This helps avoid self-occlusion artifacts.
