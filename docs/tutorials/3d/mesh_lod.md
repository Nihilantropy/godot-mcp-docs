# Mesh level of detail (LOD) {#doc_mesh_lod}
...
Threshold Pixels** project setting. To change this value at runtime, set
...
role="ref"}, you don\'t need to do anything specific in your project to
take camera FOV and viewport resolution into account.
::::
