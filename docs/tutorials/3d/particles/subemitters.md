# Particle sub-emitters {#doc_3d_particles_subemitters}

![](img/particle_sub_chain.webp)
...
worry, it didn\'t break. This happens to every particle system as soon
as it becomes a sub-emitter. You also won\'t be able to re-enable the
