# Controllers, gamepads, and joysticks {#doc_controllers_gamepads_joysticks}

Godot supports hundreds of controller models out of the box. Controllers
are supported on Windows, macOS, Linux, Android, iOS, and HTML5.
...
You can use the [Gamepad Tester](https://hardwaretester.com/gamepad)
website to confirm that your controller is recognized.
...
mapping from the SDL game controller database used by Godot or the
[Godot game controller
database](https://github.com/godotengine/godot/blob/master/core/input/godotcontrollerdb.txt).
In this case, you will need to create a custom mapping for your
controller.
...
Once you are satisfied with the custom mapping, you can contribute it
for the next Godot version by opening a pull request on the [Godot game
controller
database](https://github.com/godotengine/godot/blob/master/core/input/godotcontrollerdb.txt).
