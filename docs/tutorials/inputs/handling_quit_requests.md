# Handling quit requests {#doc_handling_quit_requests}
...
On iOS, you only have approximately 5 seconds to finish a task started
by this signal. If you go over this allotment, iOS will kill the app
