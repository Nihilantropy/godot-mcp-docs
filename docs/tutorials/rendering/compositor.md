...
resource is used to configure the compositor. To get started, create a
new compositor on the appropriate node:
...
Note the use of a `Mutex <class_Mutex>`{.interpreted-text role="ref"} in
