...
> private PackedScene [bullet]{#bullet} =
> GD.Load\<PackedScene\>(\"res://Bullet.tscn\");
>
> public override void [Input]{#input}(InputEvent \@event) { if (@event
> is InputEventMouseButton mouseButton) { if (mouseButton.ButtonIndex ==
> MouseButton.Left && mouseButton.Pressed) {
> EmitSignal(SignalName.Shoot, [bullet]{#bullet}, Rotation, Position); }
> } }
>
...
func [on_player_shoot]{#on_player_shoot}(Bullet, direction, location):
