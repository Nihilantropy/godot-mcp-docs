# C# language features {#doc_c_sharp_features}
...
- `GODOTX`, `GODOTX_Y`, `GODOTX_Y_Z`, `GODOTx_OR_GREATER`,
  ...
  These defines were first added in Godot 4.0.4 and 4.1. Version defines
  for prior versions do not exist, regardless of the current Godot
  version.
  ::::
