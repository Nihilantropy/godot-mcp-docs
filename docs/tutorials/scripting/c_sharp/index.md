...
own `GDScript <doc_gdscript>`{.interpreted-text role="ref"}.
...
and software version requirements for the Godot engine.
:::
...
Since C# projects use the .NET runtime, also check the system
requirements for the version of .NET that you\'ll be using. See
[supported
OS](https://github.com/dotnet/core/tree/main/release-notes#supported-os).
::::

Since Godot 4.2, projects written in C# support all desktop platforms
