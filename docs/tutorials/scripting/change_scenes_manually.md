# Change scenes manually {#doc_change_scenes_manually}
...
func [add_a_scene_manually]{#add_a_scene_manually}():
...
public void [AddASceneManually]{#addascenemanually}() { // This is like
autoloading the scene, only // it happens after already loading the main
scene. GetTree().Root.AddChild(simultaneousScene); }
::::
