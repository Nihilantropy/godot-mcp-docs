...
signal my_signal signal my_signal_with_params(msg: String, n: int)
...
public partial class MyCSharpNode : Node { public string MyProperty {
get; set; } = \"my c# value\";

> \[Signal\] public delegate void MySignalEventHandler(); \[Signal\]
> public delegate void MySignalWithParamsEventHandler(string msg, int
> n);
>
...
built-in types as described in
`doc_gdscript_builtin_types`{.interpreted-text role="ref"} or classes
extending `class_Object`{.interpreted-text role="ref"}.
