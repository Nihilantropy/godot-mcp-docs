# Evaluating expressions {#doc_evaluating_expressions}
...
The following operators are available:
  ...
  Division (`/`)   Performs and integer division if both operands are
                   integers. If at least one of them is a floating-point
