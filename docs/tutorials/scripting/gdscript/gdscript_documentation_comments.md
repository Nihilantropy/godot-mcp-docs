...
+-----------------+----------------------------------------------------+
| Brief           | No tag. Lives at the very beginning of the         |
| description     | documentation section.                             |
+-----------------+----------------------------------------------------+
| Description     | No tag. Use one blank line to separate the         |
...
## BBCode and class reference {#doc_gdscript_documentation_comments_bbcode_and_class_reference}
...
+===============+======================+==============================+
| | `[Class]`   | `M                   | Move the                     |
| | Link to     | ove the [Sprite2D].` | `class                       |
|   class       |                      | _Sprite2D`{.interpreted-text |
|               |                      | role="ref"}.                 |
+---------------+----------------------+------------------------------+
| |             | `See [annotati       | See                          |
|  `[annotation | on @GDScript.@rpc].` | `@GDScript.@                 |
|  Class.name]` |                      | rpc <class_@GDScript_annotat |
| | Link to     |                      | ion_@rpc>`{.interpreted-text |
|   annotation  |                      | role="ref"}.                 |
+---------------+----------------------+------------------------------+
| | `[constant  | `See [c              | See                          |
|  Class.name]` | onstant Color.RED].` | `Color.RED <class_Color_cons |
| | Link to     |                      | tant_RED>`{.interpreted-text |
|   constant    |                      | role="ref"}.                 |
+---------------+----------------------+------------------------------+
| | `[enum      | `See [en             | See                          |
|  Class.name]` | um Mesh.ArrayType].` | `Mesh.ArrayType <enum_Mesh_A |
| | Link to     |                      | rrayType>`{.interpreted-text |
|   enum        |                      | role="ref"}.                 |
+---------------+----------------------+------------------------------+
| | `[member    | `Get [me             | Get                          |
|  Class.name]` | mber Node2D.scale].` | `Node2                       |
| | Link to     |                      | D.scale <class_Node2D_proper |
|   member      |                      | ty_scale>`{.interpreted-text |
|   (property)  |                      | role="ref"}.                 |
+---------------+----------------------+------------------------------+
| | `[method    | `Call [m             | Call                         |
|  Class.name]` | ethod Node3D.hide].` | `Nod                         |
| | Link to     |                      | e3D.hide() <class_Node3D_met |
|   method      |                      | hod_hide>`{.interpreted-text |
|               |                      | role="ref"}.                 |
+---------------+----------------------+------------------------------+
| |             | `Use [constr         | Use                          |
| `[constructor | uctor Color.Color].` | `Color.                      |
|  Class.name]` |                      | Color <class_Color_construct |
| | Link to     |                      | or_Color>`{.interpreted-text |
|   built-in    |                      | role="ref"}.                 |
|   constructor |                      |                              |
+---------------+----------------------+------------------------------+
| | `[operator  | `Use [operator       | Use                          |
|  Class.name]` |  Color.operator *].` | `Color.oper                  |
| | Link to     |                      | ator * <class_Color_operator |
|   built-in    |                      | _mul_int>`{.interpreted-text |
|   operator    |                      | role="ref"}.                 |
+---------------+----------------------+------------------------------+
| | `[signal    | `Emit [si            | Emit                         |
|  Class.name]` | gnal Node.renamed].` | `Nod                         |
| | Link to     |                      | e.renamed <class_Node_signal |
|   signal      |                      | _renamed>`{.interpreted-text |
|               |                      | role="ref"}.                 |
+---------------+----------------------+------------------------------+
| |             | `See [them           | See                          |
|  `[theme_item | e_item Label.font].` | `Lab                         |
|  Class.name]` |                      | el.font <class_Label_theme_f |
| | Link to     |                      | ont_font>`{.interpreted-text |
|   theme item  |                      | role="ref"}.                 |
+---------------+----------------------+------------------------------+
| | `           | `Takes [param        | Takes `size` for the size.   |
| [param name]` | size] for the size.` |                              |
| | Parameter   |                      |                              |
|   name (as    |                      |                              |
|   code)       |                      |                              |
+---------------+----------------------+------------------------------+
...
+---------------+----------------------+------------------------------+
| | `[lb]`      | `[lb]                | \[b\]text\[/b\]              |
|   `[rb]`      | b[rb]text[lb]/b[rb]` |                              |
| | `[` and `]` |                      |                              |
|               |                      |                              |
|  respectively |                      |                              |
+---------------+----------------------+------------------------------+
| | `[b]`       | `Do [b]not[/b        | Do **not** call this method. |
|   `[/b]`      | ] call this method.` |                              |
| | Bold        |                      |                              |
+---------------+----------------------+------------------------------+
| | `[i]`       | `Returns the [i]g    | Returns the *global*         |
|   `[/i]`      | lobal[/i] position.` | position.                    |
| | Italic      |                      |                              |
+---------------+----------------------+------------------------------+
| | `[u]`       | `[u]Always[/         | <u                           |
|   `[/u]`      | u] use this method.` | >Always</u> use this method. |
| | Underline   |                      |                              |
+---------------+----------------------+------------------------------+
| | `[s]`       | `[s]Outdat           | <s>Outdated information.</s> |
|   `[/s]`      | ed information.[/s]` |                              |
| |             |                      |                              |
| Strikethrough |                      |                              |
+---------------+----------------------+------------------------------+
| | `[color]`   | `[color              | <span styl                   |
|   `[/color]`  | =red]Error![/color]` | e="color:red;">Error!</span> |
| | Color       |                      |                              |
+---------------+----------------------+------------------------------+
| | `[font]`    | `[font=res://mono    | <span style="font-famil      |
|   `[/font]`   | .ttf]LICENSE[/font]` | y:monospace;">LICENSE</span> |
| | Font        |                      |                              |
+---------------+----------------------+------------------------------+
| | `[img]`     | `[img width=32]r     | ![image]                     |
|   `[/img]`    | es://icon.svg[/img]` | (img/icon.svg){width="32px"} |
| | Image       |                      |                              |
+---------------+----------------------+------------------------------+
| | `[url]`     | | `[url]https:       | | <https://example.com>      |
|   `[/url]`    | //example.com[/url]` | | [W                         |
| | Hyperlink   | |                    | ebsite](https://example.com) |
|               | `[url=https://exampl |                              |
|               | e.com]Website[/url]` |                              |
+---------------+----------------------+------------------------------+
| | `[center]`  | `[center             | <center>2 + 2 = 4</center>   |
|   `[/center]` | ]2 + 2 = 4[/center]` |                              |
| | Horizontal  |                      |                              |
|   centering   |                      |                              |
+---------------+----------------------+------------------------------+
| | `[kbd]`     | `Press [             | Press                        |
|   `[/kbd]`    | kbd]Ctrl + C[/kbd].` | `Ctrl + C`{.interpreted-text |
| | K           |                      | role="kbd"}.                 |
| eyboard/mouse |                      |                              |
|   shortcut    |                      |                              |
+---------------+----------------------+------------------------------+
| | `[code]`    | `Returns             | Returns `true`.              |
|   `[/code]`   |  [code]true[/code].` |                              |
| | Inline code |                      |                              |
|   fragment    |                      |                              |
+---------------+----------------------+------------------------------+
