# GDScript reference {#doc_gdscript_reference}
...
+----+-----------------------------------------------------------------+
| el | See [if/else/elif](#ifelseelif).                                |
| if |                                                                 |
+----+-----------------------------------------------------------------+
| el | See [if/else/elif](#ifelseelif).                                |
| se |                                                                 |
...
| ch |                                                                 |
+----+-----------------------------------------------------------------+
| wh | Used by [pattern guards](#pattern-guards) in `match`            |
| en | statements.                                                     |
+----+-----------------------------------------------------------------+
| b  | Exits the execution of the current `for` or `while` loop.       |
| re |                                                                 |
| ak |                                                                 |
+----+-----------------------------------------------------------------+
| co | Immediately skips to the next iteration of the `for` or `while` |
| nt | loop.                                                           |
| in |                                                                 |
| ue |                                                                 |
+----+-----------------------------------------------------------------+
| pa | Used where a statement is required syntactically but execution  |
| ss | of code is undesired, e.g. in empty functions.                  |
+----+-----------------------------------------------------------------+
| re | Returns a value from a function.                                |
| tu |                                                                 |
| rn |                                                                 |
+----+-----------------------------------------------------------------+
| c  | Defines an inner class. See [Inner classes](#inner-classes).    |
| la |                                                                 |
| ss |                                                                 |
+----+-----------------------------------------------------------------+
| cl | Defines the script as a globally accessible class with the      |
| as | specified name. See [Registering named                          |
| s_ | classes](#registering-named-classes).                           |
| na |                                                                 |
| me |                                                                 |
+----+-----------------------------------------------------------------+
| e  | Defines what class to extend with the current class.            |
| xt |                                                                 |
| en |                                                                 |
| ds |                                                                 |
+----+-----------------------------------------------------------------+
| is | Tests whether a variable extends a given class, or is of a      |
|    | given built-in type.                                            |
+----+-----------------------------------------------------------------+
| in | Tests whether a value is within a string, array, range,         |
|    | dictionary, or node. When used with `for`, it iterates through  |
|    | them instead of testing.                                        |
+----+-----------------------------------------------------------------+
| as | Cast the value to a given type if possible.                     |
+----+-----------------------------------------------------------------+
| se | Refers to current class instance. See [self](#self).            |
| lf |                                                                 |
+----+-----------------------------------------------------------------+
| s  | Resolves the scope of the parent method. See                    |
| up | [Inheritance](#inheritance).                                    |
| er |                                                                 |
+----+-----------------------------------------------------------------+
| si | Defines a signal. See [Signals](#signals).                      |
| gn |                                                                 |
| al |                                                                 |
+----+-----------------------------------------------------------------+
| fu | Defines a function. See [Functions](#functions).                |
| nc |                                                                 |
+----+-----------------------------------------------------------------+
| st | Defines a static function or a static member variable.          |
| at |                                                                 |
| ic |                                                                 |
+----+-----------------------------------------------------------------+
| c  | Defines a constant. See [Constants](#constants).                |
| on |                                                                 |
| st |                                                                 |
+----+-----------------------------------------------------------------+
| en | Defines an enum. See [Enums](#enums).                           |
| um |                                                                 |
+----+-----------------------------------------------------------------+
| v  | Defines a variable. See [Variables](#variables).                |
| ar |                                                                 |
+----+-----------------------------------------------------------------+
| br | Editor helper for debugger breakpoints. Unlike breakpoints      |
| ea | created by clicking in the gutter, `breakpoint` is stored in    |
| kp | the script itself. This makes it persistent across different    |
| oi | machines when using version control.                            |
| nt |                                                                 |
+----+-----------------------------------------------------------------+
| p  | Preloads a class or variable. See [Classes as                   |
| re | resources](#classes-as-resources).                              |
| lo |                                                                 |
| ad |                                                                 |
+----+-----------------------------------------------------------------+
| a  | Waits for a signal or a coroutine to finish. See [Awaiting      |
| wa | signals or coroutines](#awaiting-signals-or-coroutines).        |
| it |                                                                 |
+----+-----------------------------------------------------------------+
| y  | Previously used for coroutines. Kept as keyword for transition. |
| ie |                                                                 |
| ld |                                                                 |
+----+-----------------------------------------------------------------+
| as | Asserts a condition, logs error on failure. Ignored in          |
| se | non-debug builds. See [Assert keyword](#assert-keyword).        |
| rt |                                                                 |
+----+-----------------------------------------------------------------+
| vo | Used to represent that a function does not return any value.    |
| id |                                                                 |
+----+-----------------------------------------------------------------+
| PI | PI constant.                                                    |
+----+-----------------------------------------------------------------+
...
| AU |                                                                 |
+----+-----------------------------------------------------------------+
| I  | Infinity constant. Used for comparisons and as result of        |
| NF | calculations.                                                   |
+----+-----------------------------------------------------------------+
| N  | NAN (not a number) constant. Used as impossible result from     |
| AN | calculations.                                                   |
+----+-----------------------------------------------------------------+
...
|                       |                                              |
|                       | Parentheses are not really an operator, but  |
...
| `foo()`               | Function call                                |
+-----------------------+----------------------------------------------+
| `await x`             | [Awaiting signals or                         |
|                       | coroutines](#awaiting-signals-or-coroutines) |
+-----------------------+----------------------------------------------+
| | `x is Node`         | Type checking                                |
| | `x is not Node`     |                                              |
|                       | See also                                     |
|                       | `is_instance_of() <class_@GDScri             |
|                       | pt_method_is_instance_of>`{.interpreted-text |
|                       | role="ref"} function.                        |
+-----------------------+----------------------------------------------+
| `x ** y`              | Power                                        |
|                       |                                              |
|                       | Multiplies `x` by itself `y` times, similar  |
|                       | to calling                                   |
|                       | `pow() <class                                |
|                       | _@GlobalScope_method_pow>`{.interpreted-text |
|                       | role="ref"} function.                        |
+-----------------------+----------------------------------------------+
| `~x`                  | Bitwise NOT                                  |
+-----------------------+----------------------------------------------+
...
|                       | `format stri                                 |
|                       | ngs <doc_gdscript_printf>`{.interpreted-text |
|                       | role="ref"}.                                 |
|                       |                                              |
|                       | **Note:** These operators have the same      |
|                       | behavior as C++, which may be unexpected for |
|                       | users coming from Python, JavaScript, etc.   |
...
| | `x not in y`        |                                              |
|                       | `in` is also used with the [for](#for)       |
|                       | keyword as part of the syntax.               |
+-----------------------+----------------------------------------------+
| | `not x`             | Boolean NOT and its                          |
| | `!x`                | `unrecomm                                    |
|                       | ended <boolean_operators>`{.interpreted-text |
|                       | role="ref"} alias                            |
+-----------------------+----------------------------------------------+
| | `x and y`           | Boolean AND and its                          |
| | `x && y`            | `unrecomm                                    |
|                       | ended <boolean_operators>`{.interpreted-text |
|                       | role="ref"} alias                            |
+-----------------------+----------------------------------------------+
| | `x or y`            | Boolean OR and its                           |
| | `x || y`            | `unrecomm                                    |
|                       | ended <boolean_operators>`{.interpreted-text |
|                       | role="ref"} alias                            |
+-----------------------+----------------------------------------------+
| `true_expr if         | Ternary if/else                              |
| cond else false_expr` |                                              |
+-----------------------+----------------------------------------------+
| `x as Node`           | [Type casting](#casting)                     |
+-----------------------+----------------------------------------------+
| | `x = y`             | Assignment (lowest priority)                 |
| | `x += y`            |                                              |
| | `x -= y`            | You cannot use an assignment operator inside |
| | `x *= y`            | an expression.                               |
| | `x /= y`            |                                              |
| | `x **= y`           |                                              |
| | `x %= y`            |                                              |
...
3.  For negative values, the `%` operator and `fmod()` use
    ...
    the `posmod() <class_@GlobalScope_method_posmod>`{.interpreted-text
    role="ref"} and
...
## Literals
  ...
  **Example(s)**                 **Description**
  ...
  `&"name"`                      `StringName <class_StringName>`{.interpreted-text
                                 role="ref"}

  `^"Node/Label"`                `NodePath <class_NodePath>`{.interpreted-text
                                 role="ref"}
  ------------------------------ ---------------------------------------------------
...
**Regular string literals** can contain the following escape sequences:
  ...
  **Escape sequence**   **Expands to**
  ...
  `\uXXXX`              UTF-16 Unicode codepoint `XXXX`
                        (hexadecimal, case-insensitive)

  `\UXXXXXX`            UTF-32 Unicode codepoint `XXXXXX`
                        (hexadecimal, case-insensitive)
  --------------------- ---------------------------------
...
#### Packed arrays {#doc_gdscript_packed_arrays}

PackedArrays are generally faster to iterate on and modify compared to a
typed Array of the same type (e.g. PackedInt64Array versus Array\[int\])
and consume less memory. In the worst case, they are expected to be as
fast as an untyped Array. Conversely, non-Packed Arrays (typed or not)
have extra convenience methods such as
`Array.map <class_Array_method_map>`{.interpreted-text role="ref"} that
PackedArrays lack. Consult the
`class reference <class_PackedFloat32Array>`{.interpreted-text
role="ref"} for details on the methods available. Typed Arrays are
generally faster to iterate on and modify than untyped Arrays.

While all Arrays can cause memory fragmentation when they become large
enough, if memory usage and performance (iteration and modification
speed) is a concern and the type of data you\'re storing is compatible
with one of the `Packed` Array types, then using those may yield
improvements. However, if you do not have such concerns (e.g. the size
of your array does not reach the tens of thousands of elements) it is
likely more helpful to use regular or typed Arrays, as they provide
convenience methods that can make your code easier to write and maintain
(and potentially faster if your data requires such operations a lot). If
the data you will store is of a known type (including your own defined
classes), prefer to use a typed Array as it may yield better performance
...
Godot 4.4 added support for typed dictionaries. On write operations,
Godot checks that element keys and values match the specified type, so
the dictionary cannot contain invalid keys or values. The GDScript
static analyzer takes typed dictionaries into account. However,
dictionary methods that return values still have the `Variant` return
type.

Typed dictionaries have the syntax `Dictionary[KeyType, ValueType]`,
where `KeyType` and `ValueType` can be any `Variant` type, native or
user class, or enum. Both the key and value type **must** be specified,
but you can use `Variant` to make either of them untyped. Nested typed
collections (like `Dictionary[String, Dictionary[String, int]]`) are not
supported.
...
`doc_gdscript_warning_system`{.interpreted-text role="ref"} for details.
::::
...
### Static variables {#doc_gdscript_basics_static_variables}
...
From inside a class, you can access static variables from any function,
...
containing the static variable **must** also be a tool script. See
`Running code in the editor <doc_running_code_in_the_editor_important_information>`{.interpreted-text
...
members (see [self](#self)), but is not always required (and should
*not* be sent as the function\'s first argument, unlike Python).
...
arguments. Since Godot 4.5, GDScript supports variadic functions. To
declare a variadic function, you need to use the *rest parameter*, which
collects all the excess arguments into an array.
...
A function can have at most one rest parameter, which must be the last
one in the parameter list. The rest parameter cannot have a default
value. Static and lambda functions can also be variadic.

Static typing works for variadic functions too. However, typed arrays
are currently not supported as a static type of the rest parameter:
...
GDScript. However, you can use `callv()` to call a function with an
array of arguments:
...
equivalent to directly referring to symbols available in the current
script. However, `self` also allows you to access properties, methods,
and other names that are defined dynamically (i.e. are expected to exist
in subtypes of the current class, or are provided using
...
Beware that accessing members of child classes in the base class is
often considered a bad practice, because this blurs the area of
responsibility of any given piece of code, making the overall
relationship between parts of your game harder to reason about. Besides
that, one can simply forget that the parent class had some expectations
about it\'s descendants.
::::
...
role="ref"} enabled. This allows icons to follow the editor\'s scale and
theming settings if the icons are designed with the same color palette
...
Named classes are globally registered, which means they become available
to use in other scripts without the need to `load` or `preload` them:
...
### Abstract classes and methods {#doc_gdscript_basics_abstract_class}

Since Godot 4.5, you can define abstract classes and methods using the
`@abstract` annotation.

An abstract class is a class that cannot be instantiated directly.
Instead, it is meant to be inherited by other classes. Attempting to
instantiate an abstract class will result in an error.

An abstract method is a method that has no implementation. Therefore, a
newline or a semicolon is expected after the function header. This
defines a contract that inheriting classes must conform to, because the
method signature must be compatible when overriding.

Inheriting classes must either provide implementations for all abstract
methods, or the inheriting class must be marked as abstract. If a class
has at least one abstract method (either its own or an unimplemented
inherited one), then it must also be marked as abstract. However, the
reverse is not true: an abstract class is allowed to have no abstract
methods.
...
If you want to declare a method as optional to be overridden, you should
use a non-abstract method and provide a default implementation.
::::

For example, you could have an abstract class called `Shape` that
defines an abstract method called `draw()`. You can then create
subclasses like `Circle` and `Square` that implement the `draw()` method
in their own way. This allows you to define a common *interface* for all
shapes without having to implement all the details in the abstract class
itself:
...
Both inner classes and classes created using `class_name` can be
abstract. This example creates two abstract classes, one of which is a
subclass of another abstract class:
...
Since an abstract class cannot be instantiated, it is not possible to
attach an abstract class to a node. If you attempt to do so, the engine
will print an error when running the scene:
...
1.  If the inherited class (`state.gd`) defines an `_init` constructor
...
can have type hints, and the type must match the variable\'s type or be
a wider type.
::::
...
If a `class_Node`{.interpreted-text role="ref"} is deleted via `free()`
or `queue_free()`, all of its children will also recursively be deleted.
::::
...
additional arguments using
`Callable.bind() <class_Callable_method_bind>`{.interpreted-text
role="ref"}. This allows you to add extra information to the connection
if the emitted signal itself doesn\'t give you access to all the data
that you need.

When the signal is emitted, the callback method receives the bound
values, in addition to those provided by the signal.
...
signal to the in-game console, we can add the character\'s name using
the bind method:
