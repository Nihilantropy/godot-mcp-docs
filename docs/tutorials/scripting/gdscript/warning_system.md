# GDScript warning system {#doc_gdscript_warning_system}
...
role="ref"} annotation. You can click on the ignore link to the left of
the warning\'s description. Godot will add an annotation above the
...
role="ref"} annotations. You can omit `@warning_ignore_restore` if you
want to ignore the specified warning types until the end of the file.
