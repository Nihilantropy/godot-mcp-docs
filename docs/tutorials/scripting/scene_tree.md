# Using SceneTree {#doc_scene_tree}
...
`OS <class_OS>`{.interpreted-text role="ref"} and servers are the
low-level API.
...
func [my_level_was_completed]{#my_level_was_completed}():
...
public void [MyLevelWasCompleted]{#mylevelwascompleted}() {
...
public void [MyLevelWasCompleted]{#mylevelwascompleted}() { var
nextScene =
