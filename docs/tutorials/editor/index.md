...
editors\' interfaces in other sections where appropriate. For example,
the `animation editor
<doc_introduction_animation>`{.interpreted-text role="ref"}.

::: {#toc-editor-interface .toctree maxdepth="1"}
project_manager inspector_dock project_settings script_editor
default_key_mapping customizing_editor
:::
