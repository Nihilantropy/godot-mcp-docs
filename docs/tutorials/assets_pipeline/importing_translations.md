# Importing translations {#doc_importing_translations}
...
`doc_localization_using_spreadsheets`{.interpreted-text role="ref"} for
detailed info on formatting and importing CSVs.
