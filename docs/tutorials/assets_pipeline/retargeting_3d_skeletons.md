# Retargeting 3D Skeletons {#doc_retargeting_3d_skeletons}
...
export a `class_skeletonprofile`{.interpreted-text role="ref"} from the
editor by selecting a Skeleton3D and using the **Skeleton3D** menu in
the 3D viewport\'s toolbar.
::::
