# General optimization tips {#doc_general_optimization}
...
This tends to be far more important in game or graphics programming than
...
loading a file containing precalculated data, or by storing the results
of complex calculations into a script constant and reading its value.
