# ParticleProcessMaterial 2D Usage {#doc_particle_process_material_2d}
...
specifically. For information on how to use it in a 3D scene see
`doc_process_material_properties`{.interpreted-text role="ref"}.
::::
...
Angular velocity is the speed at which particles rotate around their
center (in degrees/sec).
