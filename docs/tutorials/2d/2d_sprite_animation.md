# 2D sprite animation {#doc_2d_sprite_animation}
...
\@onready var [animated_sprite]{#animated_sprite} = \$AnimatedSprite2D
...
:   
    ...
    :   [animated_sprite.play]{#animated_sprite.play}(\"run\")
...
AnimatedSprite2D [animatedSprite]{#animatedsprite};
...
> [animatedSprite.Play]{#animatedsprite.play}(\"run\"); } else {
...
\@onready var [animation_player]{#animation_player} = \$AnimationPlayer
...
:   
    ...
    :   [animation_player.play]{#animation_player.play}(\"walk\")
...
> public override void [Process]{#process}(double delta) { if
> (Input.IsActionPressed(\"ui_right\")) {
> [animationPlayer.Play]{#animationplayer.play}(\"walk\"); } else {
