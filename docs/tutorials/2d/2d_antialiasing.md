# 2D antialiasing {#doc_2d_antialiasing}
...
`Rendering > Anti Aliasing > Quality > MSAA 2D<class_ProjectSettings_property_rendering/anti_aliasing/quality/msaa_2d>`{.interpreted-text
role="ref"} setting. It\'s important to change the value of the **MSAA
2D** setting and not **MSAA 3D**, as these are entirely separate
settings.
