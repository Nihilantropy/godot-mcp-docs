# OpenXR hand tracking {#doc_openxr_hand_tracking}
...
OpenXR is answering this call by introducing further extensions that
...
If there is a tracker but [has_tracking_data]{.title-ref} is false, the
