# Exporting for Windows {#doc_exporting_for_windows}
...
Godot will automatically use whatever image is set as your project\'s
icon in the project settings, and convert it to an ICO file for the
exported project. If you want to manually create an ICO file for greater
control over how the icon looks at different resolutions then see the
...
`class_EditorExportPlatformWindows`{.interpreted-text role="ref"} class
reference.
