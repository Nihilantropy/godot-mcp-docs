...
When a plugin is active, you can access it in your code using
...
The plugin\'s files have to be in the `res://ios/plugins/` directory or
a subdirectory, otherwise the Godot editor will not automatically detect
them.
::::
