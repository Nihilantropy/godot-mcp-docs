...
3.  After updating the Godot Android library dependency, sync or build
    ...
    >   longer has access to an `android.content.Context` reference. Use
...
file](https://docs.godotengine.org/en/stable/tutorials/scripting/cpp/gdextension_cpp_example.html#using-the-gdextension-module)
