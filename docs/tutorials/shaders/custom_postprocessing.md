# Custom post-processing {#doc_custom_postprocessing}
...
<img src="img/custom_postprocessing_anchors_preset_full_rect.webp"
alt="img/custom_postprocessing_anchors_preset_full_rect.webp" />
<figcaption>Setting the anchor preset to Full Rect on the ColorRect
node</figcaption>
</figure>
...
of the screen to a buffer and to access it in a shader script through a
`sampler2D` using `hint_screen_texture`.
::::
