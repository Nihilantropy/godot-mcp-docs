...
the editor, which appear next to the \"2D\", \"3D\", \"Script\",
\"Game\", and \"AssetLib\" buttons. Such editor plugins are referred as
\"Main screen plugins\".
...
func [has_main_screen]{#has_main_screen}():

:   return true

func [make_visible]{#make_visible}(visible):

:   pass

func [get_plugin_name]{#get_plugin_name}():
...
override void [EnterTree]{#entertree}() {
...
> }
>
> public override bool [HasMainScreen]{#hasmainscreen}() { return true;
> }
>
> public override void [MakeVisible]{#makevisible}(bool visible) {
>
> }
>
> public override string [GetPluginName]{#getpluginname}() { return
> \"Main Screen Plugin\"; }
>
> public override Texture2D [GetPluginIcon]{#getpluginicon}() { return
...
func [on_print_hello_pressed]{#on_print_hello_pressed}():
...
:   main_panel_instance = MainPanel.instantiate() \# Add the main panel
    ...
    [make_visible]{#make_visible}(false)
...
> public override void [EnterTree]{#entertree}() { MainPanelInstance =
...
>
> public override void [ExitTree]{#exittree}() { if (MainPanelInstance
> != null) { MainPanelInstance.QueueFree(); } }
>
> public override bool [HasMainScreen]{#hasmainscreen}() { return true;
> }
>
> public override void [MakeVisible]{#makevisible}(bool visible) { if
> (MainPanelInstance != null) { MainPanelInstance.Visible = visible; } }
>
> public override string [GetPluginName]{#getpluginname}() { return
> \"Main Screen Plugin\"; }
>
> public override Texture2D [GetPluginIcon]{#getpluginicon}() { // Must
> return some kind of Texture for the icon. return
> EditorInterface.Singleton.GetEditorTheme().GetIcon(\"Node\",
> \"EditorIcons\"); }
