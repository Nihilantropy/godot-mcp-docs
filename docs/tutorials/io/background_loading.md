# Background loading {#doc_background_loading}
...
:   ResourceLoader.load_threaded_request(ENEMY_SCENE_PATH)
    self.pressed.connect([on_button_pressed]{#on_button_pressed})
...
func [on_button_pressed]{#on_button_pressed}(): \# Button was pressed.
