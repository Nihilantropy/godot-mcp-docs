...
### 3: `float<class_float>`{.interpreted-text role="ref"}
...
### 8: `Transform2D<class_transform2d>`{.interpreted-text role="ref"}
  ...
  Offset   Len   Type    Description
  -------- ----- ------- -----------------------------------------------
  4        4     Float   The X component of the X column vector,
                         accessed via \[0\]\[0\]

  8        4     Float   The Y component of the X column vector,
                         accessed via \[0\]\[1\]

  12       4     Float   The X component of the Y column vector,
                         accessed via \[1\]\[0\]

  16       4     Float   The Y component of the Y column vector,
                         accessed via \[1\]\[1\]

  20       4     Float   The X component of the origin vector, accessed
                         via \[2\]\[0\]

  24       4     Float   The Y component of the origin vector, accessed
                         via \[2\]\[1\]
  ----------------------------------------------------------------------
...
### 10: `Quaternion<class_quaternion>`{.interpreted-text role="ref"}
...
### 12: `Basis<class_basis>`{.interpreted-text role="ref"}
  ...
  12       4     Float   The Z component of the X column vector,
                         accessed via \[0\]\[2\]

  16       4     Float   The X component of the Y column vector,
                         accessed via \[1\]\[0\]

  20       4     Float   The Y component of the Y column vector,
                         accessed via \[1\]\[1\]

  24       4     Float   The Z component of the Y column vector,
                         accessed via \[1\]\[2\]

  28       4     Float   The X component of the Z column vector,
                         accessed via \[2\]\[0\]

  32       4     Float   The Y component of the Z column vector,
                         accessed via \[2\]\[1\]

  36       4     Float   The Z component of the Z column vector,
                         accessed via \[2\]\[2\]
  ----------------------------------------------------------------------

### 13: `Transform3D<class_transform3d>`{.interpreted-text role="ref"}
  ...
  40       4     Float   The X component of the origin vector, accessed
                         via \[3\]\[0\]

  44       4     Float   The Y component of the origin vector, accessed
                         via \[3\]\[1\]

  48       4     Float   The Z component of the origin vector, accessed
                         via \[3\]\[2\]
  ----------------------------------------------------------------------
...
### 14: `Color<class_color>`{.interpreted-text role="ref"}
  ...
  Offset   Len    Type    Description
  -------- ------ ------- -----------------------------------------------
  4        4      Float   Red (typically 0..1, can be above 1 for
                          overbright colors)

  8        4      Float   Green (typically 0..1, can be above 1 for
                          overbright colors)

  12       4      Float   Blue (typically 0..1, can be above 1 for
                          overbright colors)
...
### 17: `Object<class_object>`{.interpreted-text role="ref"}
...
#### `full_objects` disabled
  ...
  Offset    Len    Type       Description
  --------- ------ ---------- ------------------------------------------
  4         8      Integer    The Object instance ID (64-bit signed
                              integer)
...
#### `full_objects` enabled
  ...
  X+8      4     Integer      The number of properties that are
                              serialized
  -----------------------------------------------------------------------
...
### 20: `PackedByteArray<class_PackedByteArray>`{.interpreted-text role="ref"}
...
### 21: `PackedInt32Array<class_PackedInt32Array>`{.interpreted-text role="ref"}
...
### 22: `PackedInt64Array<class_PackedInt64Array>`{.interpreted-text role="ref"}
...
### 23: `PackedFloat32Array<class_PackedFloat32Array>`{.interpreted-text role="ref"}
  ...
  8..8+length\*4   4      Integer    32-bit IEEE 754 single-precision
                                     float
  -----------------------------------------------------------------------

### 24: `PackedFloat64Array<class_PackedFloat64Array>`{.interpreted-text role="ref"}
  ...
  8..8+length\*8   8      Integer    64-bit IEEE 754 double-precision
                                     float
  -----------------------------------------------------------------------

### 25: `PackedStringArray<class_PackedStringArray>`{.interpreted-text role="ref"}
...
### 26: `PackedVector2Array<class_PackedVector2Array>`{.interpreted-text role="ref"}
...
### 27: `PackedVector3Array<class_PackedVector3Array>`{.interpreted-text role="ref"}
...
### 28: `PackedColorArray<class_PackedColorArray>`{.interpreted-text role="ref"}
  ...
  8..8+length\*16    4     Float     Red (typically 0..1, can be above 1 for
                                     overbright colors)

  8..12+length\*16   4     Float     Green (typically 0..1, can be above 1 for
                                     overbright colors)

  8..16+length\*16   4     Float     Blue (typically 0..1, can be above 1 for
                                     overbright colors)
