# Applying object-oriented principles in Godot {#doc_what_are_godot_classes}
...
`RefCounted <class_RefCounted>`{.interpreted-text role="ref"} class. As
a result, you can instantiate scripts without the `extends` keyword from
