...
factor. This allows automatically detecting the hiDPI display
*reliably*, instead of guessing based on the screen resolution and the
display\'s reported DPI (which might be unreliable due to broken monitor
...
role="ref"}. **Windows, macOS, Linux (X11/Wayland), Android**

:::: {#class_DisplayServer_constant_FEATURE_NATIVE_DIALOG_FILE_EXTRA}
::: rst-class
classref-enumeration-constant
:::
::::
...
The display server supports all features of
`FEATURE_NATIVE_DIALOG_FILE<class_DisplayServer_constant_FEATURE_NATIVE_DIALOG_FILE>`{.interpreted-text
role="ref"}, with the added functionality of Options and native dialog
file access to `res://` and `user://` paths. See
`file_dialog_show()<class_DisplayServer_method_file_dialog_show>`{.interpreted-text
role="ref"} and
...
:::: {#class_DisplayServer_constant_FEATURE_WINDOW_DRAG}
::: rst-class
classref-enumeration-constant
:::
::::
...
The display server supports initiating window drag and resize operations
on demand. See
`window_start_drag()<class_DisplayServer_method_window_start_drag>`{.interpreted-text
role="ref"} and
`window_start_resize()<class_DisplayServer_method_window_start_resize>`{.interpreted-text
role="ref"}.

:::: {#class_DisplayServer_constant_FEATURE_SCREEN_EXCLUDE_FROM_CAPTURE}
::: rst-class
classref-enumeration-constant
:::
::::
...
Display server supports
`WINDOW_FLAG_EXCLUDE_FROM_CAPTURE<class_DisplayServer_constant_WINDOW_FLAG_EXCLUDE_FROM_CAPTURE>`{.interpreted-text
role="ref"} window flag.

:::: {#class_DisplayServer_constant_FEATURE_WINDOW_EMBEDDING}
::: rst-class
classref-enumeration-constant
:::
::::
...
Display server supports embedding a window from another process.
**Windows, Linux (X11)**

:::: {#class_DisplayServer_constant_FEATURE_NATIVE_DIALOG_FILE_MIME}
::: rst-class
classref-enumeration-constant
:::
::::
...
:::: {#class_DisplayServer_constant_FEATURE_EMOJI_AND_SYMBOL_PICKER}
::: rst-class
classref-enumeration-constant
:::
::::
...
Display server supports system emoji and symbol picker. **Windows,
macOS**

:::: {#class_DisplayServer_constant_FEATURE_NATIVE_COLOR_PICKER}
::: rst-class
classref-enumeration-constant
:::
::::
...
:::: {#class_DisplayServer_constant_FEATURE_SELF_FITTING_WINDOWS}
::: rst-class
classref-enumeration-constant
:::
::::
...
Display server automatically fits popups according to the screen
boundaries. Window nodes should not attempt to do that themselves.

:::: {#class_DisplayServer_constant_FEATURE_ACCESSIBILITY_SCREEN_READER}
::: rst-class
classref-enumeration-constant
:::
::::
...
Display server supports interaction with screen reader or Braille
display. **Linux (X11/Wayland), macOS, Windows**
...
:::: {#enum_DisplayServer_AccessibilityRole}
::: rst-class
classref-enumeration
:::
::::
...
`🔗<enum_DisplayServer_AccessibilityRole>`{.interpreted-text role="ref"}

:::: {#class_DisplayServer_constant_ROLE_UNKNOWN}
::: rst-class
classref-enumeration-constant
:::
::::

`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_UNKNOWN** = `0`

Unknown or custom role.

:::: {#class_DisplayServer_constant_ROLE_DEFAULT_BUTTON}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_DEFAULT_BUTTON** = `1`

Default dialog button element.

:::: {#class_DisplayServer_constant_ROLE_AUDIO}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_AUDIO** = `2`

Audio player element.

:::: {#class_DisplayServer_constant_ROLE_VIDEO}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_VIDEO** = `3`

Video player element.

:::: {#class_DisplayServer_constant_ROLE_STATIC_TEXT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_STATIC_TEXT** = `4`

Non-editable text label.

:::: {#class_DisplayServer_constant_ROLE_CONTAINER}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_CONTAINER** = `5`

Container element. Elements with this role are used for internal
structure and ignored by screen readers.

:::: {#class_DisplayServer_constant_ROLE_PANEL}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_PANEL** = `6`

Panel container element.

:::: {#class_DisplayServer_constant_ROLE_BUTTON}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_BUTTON** = `7`

Button element.

:::: {#class_DisplayServer_constant_ROLE_LINK}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_LINK** = `8`

Link element.

:::: {#class_DisplayServer_constant_ROLE_CHECK_BOX}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_CHECK_BOX** = `9`

Check box element.

:::: {#class_DisplayServer_constant_ROLE_RADIO_BUTTON}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_RADIO_BUTTON** = `10`

Radio button element.

:::: {#class_DisplayServer_constant_ROLE_CHECK_BUTTON}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_CHECK_BUTTON** = `11`

Check button element.

:::: {#class_DisplayServer_constant_ROLE_SCROLL_BAR}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_SCROLL_BAR** = `12`

Scroll bar element.

:::: {#class_DisplayServer_constant_ROLE_SCROLL_VIEW}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_SCROLL_VIEW** = `13`

Scroll container element.

:::: {#class_DisplayServer_constant_ROLE_SPLITTER}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_SPLITTER** = `14`

Container splitter handle element.

:::: {#class_DisplayServer_constant_ROLE_SLIDER}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_SLIDER** = `15`

Slider element.

:::: {#class_DisplayServer_constant_ROLE_SPIN_BUTTON}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_SPIN_BUTTON** = `16`

Spin box element.

:::: {#class_DisplayServer_constant_ROLE_PROGRESS_INDICATOR}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_PROGRESS_INDICATOR** = `17`

Progress indicator element.

:::: {#class_DisplayServer_constant_ROLE_TEXT_FIELD}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_TEXT_FIELD** = `18`

Editable text field element.

:::: {#class_DisplayServer_constant_ROLE_MULTILINE_TEXT_FIELD}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_MULTILINE_TEXT_FIELD** = `19`

Multiline editable text field element.

:::: {#class_DisplayServer_constant_ROLE_COLOR_PICKER}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_COLOR_PICKER** = `20`

Color picker element.

:::: {#class_DisplayServer_constant_ROLE_TABLE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_TABLE** = `21`

Table element.

:::: {#class_DisplayServer_constant_ROLE_CELL}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_CELL** = `22`

Table/tree cell element.

:::: {#class_DisplayServer_constant_ROLE_ROW}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_ROW** = `23`

Table/tree row element.

:::: {#class_DisplayServer_constant_ROLE_ROW_GROUP}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_ROW_GROUP** = `24`

Table/tree row group element.

:::: {#class_DisplayServer_constant_ROLE_ROW_HEADER}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_ROW_HEADER** = `25`

Table/tree row header element.

:::: {#class_DisplayServer_constant_ROLE_COLUMN_HEADER}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_COLUMN_HEADER** = `26`

Table/tree column header element.

:::: {#class_DisplayServer_constant_ROLE_TREE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_TREE** = `27`

Tree view element.

:::: {#class_DisplayServer_constant_ROLE_TREE_ITEM}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_TREE_ITEM** = `28`

Tree view item element.

:::: {#class_DisplayServer_constant_ROLE_LIST}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_LIST** = `29`

List element.

:::: {#class_DisplayServer_constant_ROLE_LIST_ITEM}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_LIST_ITEM** = `30`

List item element.

:::: {#class_DisplayServer_constant_ROLE_LIST_BOX}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_LIST_BOX** = `31`

List view element.

:::: {#class_DisplayServer_constant_ROLE_LIST_BOX_OPTION}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_LIST_BOX_OPTION** = `32`

List view item element.

:::: {#class_DisplayServer_constant_ROLE_TAB_BAR}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_TAB_BAR** = `33`

Tab bar element.

:::: {#class_DisplayServer_constant_ROLE_TAB}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_TAB** = `34`

Tab bar item element.

:::: {#class_DisplayServer_constant_ROLE_TAB_PANEL}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_TAB_PANEL** = `35`

Tab panel element.

:::: {#class_DisplayServer_constant_ROLE_MENU_BAR}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_MENU_BAR** = `36`

Menu bar element.

:::: {#class_DisplayServer_constant_ROLE_MENU}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_MENU** = `37`

Popup menu element.

:::: {#class_DisplayServer_constant_ROLE_MENU_ITEM}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_MENU_ITEM** = `38`

Popup menu item element.

:::: {#class_DisplayServer_constant_ROLE_MENU_ITEM_CHECK_BOX}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_MENU_ITEM_CHECK_BOX** = `39`

Popup menu check button item element.

:::: {#class_DisplayServer_constant_ROLE_MENU_ITEM_RADIO}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_MENU_ITEM_RADIO** = `40`

Popup menu radio button item element.

:::: {#class_DisplayServer_constant_ROLE_IMAGE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_IMAGE** = `41`

Image element.

:::: {#class_DisplayServer_constant_ROLE_WINDOW}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_WINDOW** = `42`

Window element.

:::: {#class_DisplayServer_constant_ROLE_TITLE_BAR}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_TITLE_BAR** = `43`

Embedded window title bar element.

:::: {#class_DisplayServer_constant_ROLE_DIALOG}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"} **ROLE_DIALOG** = `44`

Dialog window element.

:::: {#class_DisplayServer_constant_ROLE_TOOLTIP}
::: rst-class
classref-enumeration-constant
:::
::::
...
:::: {#enum_DisplayServer_AccessibilityPopupType}
::: rst-class
classref-enumeration
:::
::::
...
`🔗<enum_DisplayServer_AccessibilityPopupType>`{.interpreted-text
role="ref"}

:::: {#class_DisplayServer_constant_POPUP_MENU}
::: rst-class
classref-enumeration-constant
:::
::::

`AccessibilityPopupType<enum_DisplayServer_AccessibilityPopupType>`{.interpreted-text
role="ref"} **POPUP_MENU** = `0`

Popup menu.

:::: {#class_DisplayServer_constant_POPUP_LIST}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityPopupType<enum_DisplayServer_AccessibilityPopupType>`{.interpreted-text
role="ref"} **POPUP_LIST** = `1`

Popup list.

:::: {#class_DisplayServer_constant_POPUP_TREE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityPopupType<enum_DisplayServer_AccessibilityPopupType>`{.interpreted-text
role="ref"} **POPUP_TREE** = `2`

Popup tree view.

:::: {#class_DisplayServer_constant_POPUP_DIALOG}
::: rst-class
classref-enumeration-constant
:::
::::
...
:::: {#enum_DisplayServer_AccessibilityFlags}
::: rst-class
classref-enumeration
:::
::::
...
`🔗<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"}

:::: {#class_DisplayServer_constant_FLAG_HIDDEN}
::: rst-class
classref-enumeration-constant
:::
::::

`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_HIDDEN** = `0`

Element is hidden for accessibility tools.

:::: {#class_DisplayServer_constant_FLAG_MULTISELECTABLE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_MULTISELECTABLE** = `1`

Element is support multiple item selection.

:::: {#class_DisplayServer_constant_FLAG_REQUIRED}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_REQUIRED** = `2`

Element require user input.

:::: {#class_DisplayServer_constant_FLAG_VISITED}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_VISITED** = `3`

Element is a visited link.

:::: {#class_DisplayServer_constant_FLAG_BUSY}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_BUSY** = `4`

Element content is not ready (e.g. loading).

:::: {#class_DisplayServer_constant_FLAG_MODAL}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_MODAL** = `5`

Element is modal window.

:::: {#class_DisplayServer_constant_FLAG_TOUCH_PASSTHROUGH}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_TOUCH_PASSTHROUGH** = `6`

Element allows touches to be passed through when a screen reader is in
touch exploration mode.

:::: {#class_DisplayServer_constant_FLAG_READONLY}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_READONLY** = `7`

Element is text field with selectable but read-only text.

:::: {#class_DisplayServer_constant_FLAG_DISABLED}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_DISABLED** = `8`

Element is disabled.

:::: {#class_DisplayServer_constant_FLAG_CLIPS_CHILDREN}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"} **FLAG_CLIPS_CHILDREN** = `9`
...
:::: {#enum_DisplayServer_AccessibilityAction}
::: rst-class
classref-enumeration
:::
::::
...
`🔗<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"}

:::: {#class_DisplayServer_constant_ACTION_CLICK}
::: rst-class
classref-enumeration-constant
:::
::::

`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_CLICK** = `0`

Single click action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_FOCUS}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_FOCUS** = `1`

Focus action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_BLUR}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_BLUR** = `2`

Blur action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_COLLAPSE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_COLLAPSE** = `3`

Collapse action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_EXPAND}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_EXPAND** = `4`

Expand action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_DECREMENT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_DECREMENT** = `5`

Decrement action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_INCREMENT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_INCREMENT** = `6`

Increment action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_HIDE_TOOLTIP}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_HIDE_TOOLTIP** = `7`

Hide tooltip action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_SHOW_TOOLTIP}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SHOW_TOOLTIP** = `8`

Show tooltip action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_SET_TEXT_SELECTION}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SET_TEXT_SELECTION** = `9`

Set text selection action, callback argument is set to
`Dictionary<class_Dictionary>`{.interpreted-text role="ref"} with the
following keys:

- `"start_element"` accessibility element of the selection start.
- `"start_char"` character offset relative to the accessibility element
  of the selection start.
- `"end_element"` accessibility element of the selection end.
- `"end_char"` character offset relative to the accessibility element of
  the selection end.

:::: {#class_DisplayServer_constant_ACTION_REPLACE_SELECTED_TEXT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_REPLACE_SELECTED_TEXT** = `10`

Replace text action, callback argument is set to
`String<class_String>`{.interpreted-text role="ref"} with the
replacement text.

:::: {#class_DisplayServer_constant_ACTION_SCROLL_BACKWARD}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SCROLL_BACKWARD** = `11`

Scroll backward action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_SCROLL_DOWN}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SCROLL_DOWN** = `12`

Scroll down action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_SCROLL_FORWARD}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SCROLL_FORWARD** = `13`

Scroll forward action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_SCROLL_LEFT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SCROLL_LEFT** = `14`

Scroll left action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_SCROLL_RIGHT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SCROLL_RIGHT** = `15`

Scroll right action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_SCROLL_UP}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SCROLL_UP** = `16`

Scroll up action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_SCROLL_INTO_VIEW}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SCROLL_INTO_VIEW** = `17`

Scroll into view action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_SCROLL_TO_POINT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SCROLL_TO_POINT** = `18`

Scroll to point action, callback argument is set to
`Vector2<class_Vector2>`{.interpreted-text role="ref"} with the relative
point coordinates.

:::: {#class_DisplayServer_constant_ACTION_SET_SCROLL_OFFSET}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SET_SCROLL_OFFSET** = `19`

Set scroll offset action, callback argument is set to
`Vector2<class_Vector2>`{.interpreted-text role="ref"} with the scroll
offset.

:::: {#class_DisplayServer_constant_ACTION_SET_VALUE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SET_VALUE** = `20`

Set value action, callback argument is set to
`String<class_String>`{.interpreted-text role="ref"} or number with the
new value.

:::: {#class_DisplayServer_constant_ACTION_SHOW_CONTEXT_MENU}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"} **ACTION_SHOW_CONTEXT_MENU** = `21`

Show context menu action, callback argument is not set.

:::: {#class_DisplayServer_constant_ACTION_CUSTOM}
::: rst-class
classref-enumeration-constant
:::
::::
...
:::: {#enum_DisplayServer_AccessibilityLiveMode}
::: rst-class
classref-enumeration
:::
::::
...
`🔗<enum_DisplayServer_AccessibilityLiveMode>`{.interpreted-text
role="ref"}

:::: {#class_DisplayServer_constant_LIVE_OFF}
::: rst-class
classref-enumeration-constant
:::
::::

`AccessibilityLiveMode<enum_DisplayServer_AccessibilityLiveMode>`{.interpreted-text
role="ref"} **LIVE_OFF** = `0`

Indicates that updates to the live region should not be presented.

:::: {#class_DisplayServer_constant_LIVE_POLITE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityLiveMode<enum_DisplayServer_AccessibilityLiveMode>`{.interpreted-text
role="ref"} **LIVE_POLITE** = `1`

Indicates that updates to the live region should be presented at the
next opportunity (for example at the end of speaking the current
sentence).

:::: {#class_DisplayServer_constant_LIVE_ASSERTIVE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`AccessibilityLiveMode<enum_DisplayServer_AccessibilityLiveMode>`{.interpreted-text
role="ref"} **LIVE_ASSERTIVE** = `2`

Indicates that updates to the live region have the highest priority and
...
:::: {#class_DisplayServer_constant_MOUSE_MODE_MAX}
::: rst-class
classref-enumeration-constant
:::
::::
...
\*\*On Linux (Wayland):\*\* Equivalent to
...
\*\*Note:\*\* Transparency support is implemented on Android, but can
only be enabled via
...
role="ref"}. This flag has no effect on Android.
...
:::: {#class_DisplayServer_constant_WINDOW_FLAG_EXCLUDE_FROM_CAPTURE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowFlags<enum_DisplayServer_WindowFlags>`{.interpreted-text
role="ref"} **WINDOW_FLAG_EXCLUDE_FROM_CAPTURE** = `9`

Window is excluded from screenshots taken by
`screen_get_image()<class_DisplayServer_method_screen_get_image>`{.interpreted-text
role="ref"},
`screen_get_image_rect()<class_DisplayServer_method_screen_get_image_rect>`{.interpreted-text
role="ref"}, and
`screen_get_pixel()<class_DisplayServer_method_screen_get_pixel>`{.interpreted-text
role="ref"}.
...
\*\*Note:\*\* Setting this flag will prevent standard screenshot methods
from capturing a window image, but does **NOT** guarantee that other
apps won\'t be able to capture an image. It should not be used as a DRM
or security measure.

:::: {#class_DisplayServer_constant_WINDOW_FLAG_POPUP_WM_HINT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowFlags<enum_DisplayServer_WindowFlags>`{.interpreted-text
role="ref"} **WINDOW_FLAG_POPUP_WM_HINT** = `10`

Signals the window manager that this window is supposed to be an
implementation-defined \"popup\" (usually a floating, borderless,
untileable and immovable child window).

:::: {#class_DisplayServer_constant_WINDOW_FLAG_MINIMIZE_DISABLED}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowFlags<enum_DisplayServer_WindowFlags>`{.interpreted-text
role="ref"} **WINDOW_FLAG_MINIMIZE_DISABLED** = `11`

Window minimize button is disabled.

\*\*Note:\*\* This flag is implemented on macOS and Windows.

:::: {#class_DisplayServer_constant_WINDOW_FLAG_MAXIMIZE_DISABLED}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowFlags<enum_DisplayServer_WindowFlags>`{.interpreted-text
role="ref"} **WINDOW_FLAG_MAXIMIZE_DISABLED** = `12`
...
\*\*Note:\*\* This flag is implemented only on macOS and Linux
(Wayland).
...
:::: {#class_DisplayServer_constant_WINDOW_EVENT_FORCE_CLOSE}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowEvent<enum_DisplayServer_WindowEvent>`{.interpreted-text
role="ref"} **WINDOW_EVENT_FORCE_CLOSE** = `8`

Sent when the window has been forcibly closed by the Display Server. The
window shall immediately hide and clean any internal rendering
references.
...
:::: {#enum_DisplayServer_WindowResizeEdge}
::: rst-class
classref-enumeration
:::
::::
...
`🔗<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text role="ref"}

:::: {#class_DisplayServer_constant_WINDOW_EDGE_TOP_LEFT}
::: rst-class
classref-enumeration-constant
:::
::::

`WindowResizeEdge<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text
role="ref"} **WINDOW_EDGE_TOP_LEFT** = `0`

Top-left edge of a window.

:::: {#class_DisplayServer_constant_WINDOW_EDGE_TOP}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowResizeEdge<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text
role="ref"} **WINDOW_EDGE_TOP** = `1`

Top edge of a window.

:::: {#class_DisplayServer_constant_WINDOW_EDGE_TOP_RIGHT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowResizeEdge<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text
role="ref"} **WINDOW_EDGE_TOP_RIGHT** = `2`

Top-right edge of a window.

:::: {#class_DisplayServer_constant_WINDOW_EDGE_LEFT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowResizeEdge<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text
role="ref"} **WINDOW_EDGE_LEFT** = `3`

Left edge of a window.

:::: {#class_DisplayServer_constant_WINDOW_EDGE_RIGHT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowResizeEdge<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text
role="ref"} **WINDOW_EDGE_RIGHT** = `4`

Right edge of a window.

:::: {#class_DisplayServer_constant_WINDOW_EDGE_BOTTOM_LEFT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowResizeEdge<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text
role="ref"} **WINDOW_EDGE_BOTTOM_LEFT** = `5`

Bottom-left edge of a window.

:::: {#class_DisplayServer_constant_WINDOW_EDGE_BOTTOM}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowResizeEdge<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text
role="ref"} **WINDOW_EDGE_BOTTOM** = `6`

Bottom edge of a window.

:::: {#class_DisplayServer_constant_WINDOW_EDGE_BOTTOM_RIGHT}
::: rst-class
classref-enumeration-constant
:::
::::
...
`WindowResizeEdge<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text
role="ref"} **WINDOW_EDGE_BOTTOM_RIGHT** = `7`

Bottom-right edge of a window.

:::: {#class_DisplayServer_constant_WINDOW_EDGE_MAX}
::: rst-class
classref-enumeration-constant
:::
::::
...
:::: {#class_DisplayServer_constant_INVALID_SCREEN}
::: rst-class
classref-constant
:::
::::
...
**INVALID_SCREEN** = `-1`
`🔗<class_DisplayServer_constant_INVALID_SCREEN>`{.interpreted-text
role="ref"}

The ID that refers to a screen that does not exist. This is returned by
some **DisplayServer** methods if no screen matches the requested
result.
...
\*\*Note:\*\* On Android, iOS, Web, and Linux (Wayland), this constant
always represents the screen at index `0`.
...
:::: {#class_DisplayServer_method_accessibility_create_element}
::: rst-class
classref-method
:::
::::
...
**accessibility_create_element**(window_id:
`int<class_int>`{.interpreted-text role="ref"}, role:
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"})
`🔗<class_DisplayServer_method_accessibility_create_element>`{.interpreted-text
role="ref"}

Creates a new, empty accessibility element resource.

\*\*Note:\*\* An accessibility element is created and freed
automatically for each `Node<class_Node>`{.interpreted-text role="ref"}.
In general, this function should not be called manually.
...
:::: {#class_DisplayServer_method_accessibility_create_sub_element}
::: rst-class
classref-method
:::
::::
...
`RID<class_RID>`{.interpreted-text role="ref"}
**accessibility_create_sub_element**(parent_rid:
`RID<class_RID>`{.interpreted-text role="ref"}, role:
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"}, insert_pos: `int<class_int>`{.interpreted-text role="ref"}
= -1)
`🔗<class_DisplayServer_method_accessibility_create_sub_element>`{.interpreted-text
role="ref"}

Creates a new, empty accessibility sub-element resource. Sub-elements
can be used to provide accessibility information for objects which are
not `Node<class_Node>`{.interpreted-text role="ref"}s, such as list
items, table cells, or menu items. Sub-elements are freed automatically
when the parent element is freed, or can be freed early using the
`accessibility_free_element()<class_DisplayServer_method_accessibility_free_element>`{.interpreted-text
role="ref"} method.
...
`RID<class_RID>`{.interpreted-text role="ref"}
**accessibility_create_sub_text_edit_elements**(parent_rid:
`RID<class_RID>`{.interpreted-text role="ref"}, shaped_text:
`RID<class_RID>`{.interpreted-text role="ref"}, min_height:
`float<class_float>`{.interpreted-text role="ref"}, insert_pos:
`int<class_int>`{.interpreted-text role="ref"} = -1)
`🔗<class_DisplayServer_method_accessibility_create_sub_text_edit_elements>`{.interpreted-text
role="ref"}

Creates a new, empty accessibility sub-element from the shaped text
buffer. Sub-elements are freed automatically when the parent element is
freed, or can be freed early using the
`accessibility_free_element()<class_DisplayServer_method_accessibility_free_element>`{.interpreted-text
role="ref"} method.
...
:::: {#class_DisplayServer_method_accessibility_element_get_meta}
::: rst-class
classref-method
:::
::::
...
**accessibility_element_get_meta**(id:
`RID<class_RID>`{.interpreted-text role="ref"})
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_DisplayServer_method_accessibility_element_get_meta>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_element_set_meta}
::: rst-class
classref-method
:::
::::
...
**accessibility_element_set_meta**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, meta:
`Variant<class_Variant>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_element_set_meta>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_free_element}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_free_element**(id: `RID<class_RID>`{.interpreted-text
role="ref"})
`🔗<class_DisplayServer_method_accessibility_free_element>`{.interpreted-text
role="ref"}

Frees an object created by
`accessibility_create_element()<class_DisplayServer_method_accessibility_create_element>`{.interpreted-text
role="ref"},
`accessibility_create_sub_element()<class_DisplayServer_method_accessibility_create_sub_element>`{.interpreted-text
role="ref"}, or
`accessibility_create_sub_text_edit_elements()<class_DisplayServer_method_accessibility_create_sub_text_edit_elements>`{.interpreted-text
role="ref"}.
...
:::: {#class_DisplayServer_method_accessibility_get_window_root}
::: rst-class
classref-method
:::
::::
...
`RID<class_RID>`{.interpreted-text role="ref"}
**accessibility_get_window_root**(window_id:
`int<class_int>`{.interpreted-text role="ref"})
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_DisplayServer_method_accessibility_get_window_root>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_has_element}
::: rst-class
classref-method
:::
::::
...
**accessibility_has_element**(id: `RID<class_RID>`{.interpreted-text
role="ref"})
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_DisplayServer_method_accessibility_has_element>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_screen_reader_active}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_DisplayServer_method_accessibility_screen_reader_active>`{.interpreted-text
role="ref"}

Returns `1` if a screen reader, Braille display or other assistive app
is active, `0` otherwise. Returns `-1` if status is unknown.

\*\*Note:\*\* This method is implemented on Linux, macOS, and Windows.

\*\*Note:\*\* Accessibility debugging tools, such as Accessibility
Insights for Windows, macOS Accessibility Inspector, or AT-SPI Browser
do not count as assistive apps and will not affect this value. To test
your app with these tools, set
`ProjectSettings.accessibility/general/accessibility_support<class_ProjectSettings_property_accessibility/general/accessibility_support>`{.interpreted-text
role="ref"} to `1`.
...
:::: {#class_DisplayServer_method_accessibility_set_window_focused}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_set_window_focused**(window_id:
`int<class_int>`{.interpreted-text role="ref"}, focused:
`bool<class_bool>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_set_window_focused>`{.interpreted-text
role="ref"}
...
`Window<class_Window>`{.interpreted-text role="ref"} objects call this
...
:::: {#class_DisplayServer_method_accessibility_set_window_rect}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_set_window_rect**(window_id:
`int<class_int>`{.interpreted-text role="ref"}, rect_out:
`Rect2<class_Rect2>`{.interpreted-text role="ref"}, rect_in:
`Rect2<class_Rect2>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_set_window_rect>`{.interpreted-text
role="ref"}

Sets window outer (with decorations) and inner (without decorations)
bounds for assistive apps.
...
:::: {#class_DisplayServer_method_accessibility_should_increase_contrast}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_DisplayServer_method_accessibility_should_increase_contrast>`{.interpreted-text
role="ref"}

Returns `1` if a high-contrast user interface theme should be used, `0`
otherwise. Returns `-1` if status is unknown.

\*\*Note:\*\* This method is implemented on Linux (X11/Wayland, GNOME),
macOS, and Windows.
...
:::: {#class_DisplayServer_method_accessibility_should_reduce_animation}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_DisplayServer_method_accessibility_should_reduce_animation>`{.interpreted-text
role="ref"}

Returns `1` if flashing, blinking, and other moving content that can
cause seizures in users with photosensitive epilepsy should be disabled,
`0` otherwise. Returns `-1` if status is unknown.
...
:::: {#class_DisplayServer_method_accessibility_should_reduce_transparency}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_DisplayServer_method_accessibility_should_reduce_transparency>`{.interpreted-text
role="ref"}

Returns `1` if background images, transparency, and other features that
can reduce the contrast between the foreground and background should be
disabled, `0` otherwise. Returns `-1` if status is unknown.
...
:::: {#class_DisplayServer_method_accessibility_update_add_action}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_add_action**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, action:
`AccessibilityAction<enum_DisplayServer_AccessibilityAction>`{.interpreted-text
role="ref"}, callable: `Callable<class_Callable>`{.interpreted-text
role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_add_action>`{.interpreted-text
role="ref"}

Adds a callback for the accessibility action (action which can be
performed by using a special screen reader command or buttons on the
Braille display), and marks this action as supported. The action
callback receives one `Variant<class_Variant>`{.interpreted-text
role="ref"} argument, which value depends on action type.
...
:::: {#class_DisplayServer_method_accessibility_update_add_child}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_add_child**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, child_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_add_child>`{.interpreted-text
role="ref"}

Adds a child accessibility element.

\*\*Note:\*\* `Node<class_Node>`{.interpreted-text role="ref"} children
and sub-elements are added to the child list automatically.
...
:::: {#class_DisplayServer_method_accessibility_update_add_custom_action}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_add_custom_action**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, action_id:
`int<class_int>`{.interpreted-text role="ref"}, action_description:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_add_custom_action>`{.interpreted-text
role="ref"}

Adds support for a custom accessibility action. `action_id` is passed as
an argument to the callback of
`ACTION_CUSTOM<class_DisplayServer_constant_ACTION_CUSTOM>`{.interpreted-text
role="ref"} action.
...
:::: {#class_DisplayServer_method_accessibility_update_add_related_controls}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_add_related_controls**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, related_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_add_related_controls>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_add_related_described_by}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_add_related_described_by**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, related_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_add_related_described_by>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_add_related_details}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_add_related_details**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, related_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_add_related_details>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_add_related_flow_to}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_add_related_flow_to**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, related_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_add_related_flow_to>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_add_related_labeled_by}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_add_related_labeled_by**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, related_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_add_related_labeled_by>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_add_related_radio_group}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_add_related_radio_group**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, related_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_add_related_radio_group>`{.interpreted-text
role="ref"}

Adds an element that is part of the same radio group.

\*\*Note:\*\* This method should be called on each element of the group,
using all other elements as `related_id`.
...
:::: {#class_DisplayServer_method_accessibility_update_set_active_descendant}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_active_descendant**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, other_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_active_descendant>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_background_color}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_background_color**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, color:
`Color<class_Color>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_background_color>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_bounds}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_bounds**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, p_rect:
`Rect2<class_Rect2>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_bounds>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_checked}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_checked**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, checekd:
`bool<class_bool>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_checked>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_classname}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_classname**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, classname:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_classname>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_color_value}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_color_value**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, color:
`Color<class_Color>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_color_value>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_description}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_description**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, description:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_description>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_error_message}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_error_message**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, other_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_error_message>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_extra_info}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_extra_info**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, name:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_extra_info>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_flag}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_flag**(id: `RID<class_RID>`{.interpreted-text
role="ref"}, flag:
`AccessibilityFlags<enum_DisplayServer_AccessibilityFlags>`{.interpreted-text
role="ref"}, value: `bool<class_bool>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_flag>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_focus}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_focus**(id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_focus>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_foreground_color}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_foreground_color**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, color:
`Color<class_Color>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_foreground_color>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_in_page_link_target}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_in_page_link_target**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, other_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_in_page_link_target>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_language}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_language**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, language:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_language>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_list_item_count}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_list_item_count**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, size:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_list_item_count>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_list_item_expanded}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_list_item_expanded**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, expanded:
`bool<class_bool>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_list_item_expanded>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_list_item_index}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_list_item_index**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, index:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_list_item_index>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_list_item_level}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_list_item_level**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, level:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_list_item_level>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_list_item_selected}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_list_item_selected**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, selected:
`bool<class_bool>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_list_item_selected>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_list_orientation}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_list_orientation**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, vertical:
`bool<class_bool>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_list_orientation>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_live}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_live**(id: `RID<class_RID>`{.interpreted-text
role="ref"}, live:
`AccessibilityLiveMode<enum_DisplayServer_AccessibilityLiveMode>`{.interpreted-text
role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_live>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_member_of}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_member_of**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, group_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_member_of>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_name}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_name**(id: `RID<class_RID>`{.interpreted-text
role="ref"}, name: `String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_name>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_next_on_line}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_next_on_line**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, other_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_next_on_line>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_num_jump}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_num_jump**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, jump:
`float<class_float>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_num_jump>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_num_range}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_num_range**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, min:
`float<class_float>`{.interpreted-text role="ref"}, max:
`float<class_float>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_num_range>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_num_step}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_num_step**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, step:
`float<class_float>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_num_step>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_num_value}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_num_value**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, position:
`float<class_float>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_num_value>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_placeholder}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_placeholder**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, placeholder:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_placeholder>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_popup_type}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_popup_type**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, popup:
`AccessibilityPopupType<enum_DisplayServer_AccessibilityPopupType>`{.interpreted-text
role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_popup_type>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_previous_on_line}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_previous_on_line**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, other_id:
`RID<class_RID>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_previous_on_line>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_role}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_role**(id: `RID<class_RID>`{.interpreted-text
role="ref"}, role:
`AccessibilityRole<enum_DisplayServer_AccessibilityRole>`{.interpreted-text
role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_role>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_role_description}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_role_description**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, description:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_role_description>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_scroll_x}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_scroll_x**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, position:
`float<class_float>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_scroll_x>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_scroll_x_range}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_scroll_x_range**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, min:
`float<class_float>`{.interpreted-text role="ref"}, max:
`float<class_float>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_scroll_x_range>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_scroll_y}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_scroll_y**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, position:
`float<class_float>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_scroll_y>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_scroll_y_range}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_scroll_y_range**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, min:
`float<class_float>`{.interpreted-text role="ref"}, max:
`float<class_float>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_scroll_y_range>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_shortcut}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_shortcut**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, shortcut:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_shortcut>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_state_description}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_state_description**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, description:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_state_description>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_table_cell_position}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_table_cell_position**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, row_index:
`int<class_int>`{.interpreted-text role="ref"}, column_index:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_table_cell_position>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_table_cell_span}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_table_cell_span**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, row_span:
`int<class_int>`{.interpreted-text role="ref"}, column_span:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_table_cell_span>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_table_column_count}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_table_column_count**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, count:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_table_column_count>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_table_column_index}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_table_column_index**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, index:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_table_column_index>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_table_row_count}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_table_row_count**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, count:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_table_row_count>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_table_row_index}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_table_row_index**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, index:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_table_row_index>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_text_align}
::: rst-class
classref-method
:::
::::
...
:::: {#class_DisplayServer_method_accessibility_update_set_text_decorations}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_text_decorations**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, underline:
`bool<class_bool>`{.interpreted-text role="ref"}, strikethrough:
`bool<class_bool>`{.interpreted-text role="ref"}, overline:
`bool<class_bool>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_text_decorations>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_text_orientation}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_text_orientation**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, vertical:
`bool<class_bool>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_text_orientation>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_text_selection}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_text_selection**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, text_start_id:
`RID<class_RID>`{.interpreted-text role="ref"}, start_char:
`int<class_int>`{.interpreted-text role="ref"}, text_end_id:
`RID<class_RID>`{.interpreted-text role="ref"}, end_char:
`int<class_int>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_text_selection>`{.interpreted-text
role="ref"}

Sets text selection to the text field. `text_start_id` and `text_end_id`
should be elements created by
`accessibility_create_sub_text_edit_elements()<class_DisplayServer_method_accessibility_create_sub_text_edit_elements>`{.interpreted-text
role="ref"}. Character offsets are relative to the corresponding
element.
...
:::: {#class_DisplayServer_method_accessibility_update_set_tooltip}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_tooltip**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, tooltip:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_tooltip>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_transform}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_transform**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, transform:
`Transform2D<class_Transform2D>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_transform>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_url}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_url**(id: `RID<class_RID>`{.interpreted-text
role="ref"}, url: `String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_url>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_accessibility_update_set_value}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**accessibility_update_set_value**(id:
`RID<class_RID>`{.interpreted-text role="ref"}, value:
`String<class_String>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_accessibility_update_set_value>`{.interpreted-text
role="ref"}
...
:::: {#class_DisplayServer_method_beep}
::: rst-class
classref-method
:::
::::

`void (No return value.)`{.interpreted-text role="abbr"} **beep**()
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"} `🔗<class_DisplayServer_method_beep>`{.interpreted-text
role="ref"}

Plays the beep sound from the operative system, if possible. Because it
comes from the OS, the beep sound will be audible even if the
application is muted. It may also be disabled for the entire OS by the
user.

\*\*Note:\*\* This method is implemented on macOS, Linux (X11/Wayland),
and Windows.
...
\*\*Note:\*\* This method uses the copied pixel data, e.g. from an image
...
:::: {#class_DisplayServer_method_color_picker}
::: rst-class
classref-method
:::
::::
...
`bool<class_bool>`{.interpreted-text role="ref"}
**color_picker**(callback: `Callable<class_Callable>`{.interpreted-text
role="ref"})
`🔗<class_DisplayServer_method_color_picker>`{.interpreted-text
role="ref"}
...
`FEATURE_NATIVE_COLOR_PICKER<class_DisplayServer_constant_FEATURE_NATIVE_COLOR_PICKER>`{.interpreted-text
role="ref"} feature.
...
role="ref"} feature. Supported platforms include macOS, Windows, and
Android.
...
`*.png,*.jpg,*.jpeg;Image Files;image/png,image/jpeg`. The description
text of the filter is optional and can be omitted. It is recommended to
set both file extension and MIME type. See also
...
**On Android,** the third callback argument (`selected_filter_index`) is
always `0`.

\*\*Note:\*\* This method is implemented if the display server has the
`FEATURE_NATIVE_DIALOG_FILE<class_DisplayServer_constant_FEATURE_NATIVE_DIALOG_FILE>`{.interpreted-text
role="ref"} feature. Supported platforms include Linux (X11/Wayland),
Windows, macOS, and Android (API level 29+).

\*\*Note:\*\* `current_directory` might be ignored.

\*\*Note:\*\* Embedded file dialog and Windows file dialog support only
file extensions, while Android, Linux, and macOS file dialogs also
support MIME types.
...
\*\*Note:\*\* This method is implemented if the display server has the
`FEATURE_NATIVE_DIALOG_FILE_EXTRA<class_DisplayServer_constant_FEATURE_NATIVE_DIALOG_FILE_EXTRA>`{.interpreted-text
role="ref"} feature. Supported platforms include Linux (X11/Wayland),
Windows, and macOS.
...
\*\*Note:\*\* This method is implemented on macOS, Windows, Android, and
Linux (X11/Wayland).
...
\*\*Note:\*\* Currently only implemented on Android and iOS. On other
platforms, `screen_get_usable_rect(SCREEN_OF_MAIN_WINDOW)` will be
returned as a fallback. See also
...
Windows. On other platforms, this method always returns the primary
screen.
...
\*\*Note:\*\* This method is implemented on Linux/X11, macOS, and
Windows. On other platforms, this method always returns `0`.
...
\*\*Note:\*\* This method is implemented on Linux (X11 and Wayland),
macOS, and Windows. On other platforms, this method always returns `1`.
...
rectangle. Returns
`INVALID_SCREEN<class_DisplayServer_constant_INVALID_SCREEN>`{.interpreted-text
role="ref"} if the rectangle doesn\'t overlap with any screen or has no
area.
...
platform specific default value if `screen` is invalid.

\*\*Note:\*\* One of the following constants can be used as `screen`:
`SCREEN_OF_MAIN_WINDOW<class_DisplayServer_constant_SCREEN_OF_MAIN_WINDOW>`{.interpreted-text
role="ref"},
`SCREEN_PRIMARY<class_DisplayServer_constant_SCREEN_PRIMARY>`{.interpreted-text
role="ref"},
`SCREEN_WITH_MOUSE_FOCUS<class_DisplayServer_constant_SCREEN_WITH_MOUSE_FOCUS>`{.interpreted-text
role="ref"}, or
`SCREEN_WITH_KEYBOARD_FOCUS<class_DisplayServer_constant_SCREEN_WITH_KEYBOARD_FOCUS>`{.interpreted-text
role="ref"}.
...
\*\*Note:\*\* This method is implemented on Android, iOS, Linux
(X11/Wayland), macOS, Web, and Windows. On other platforms, this method
always returns `72`.
...
Returns a screenshot of the `screen`. Returns `null` if `screen` is
invalid or the **DisplayServer** fails to capture screenshot.
...
\*\*Note:\*\* This method is implemented on Linux (X11, excluding
XWayland), macOS, and Windows. On other platforms, this method always
returns `null`.

\*\*Note:\*\* On macOS, this method requires the \"Screen Recording\"
permission. If permission is not granted, this method returns a
screenshot that will not include other application windows or OS
elements not related to the application.
...
:::: {#class_DisplayServer_method_screen_get_image_rect}
::: rst-class
classref-method
:::
::::
...
`Image<class_Image>`{.interpreted-text role="ref"}
**screen_get_image_rect**(rect: `Rect2i<class_Rect2i>`{.interpreted-text
role="ref"})
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_DisplayServer_method_screen_get_image_rect>`{.interpreted-text
role="ref"}

Returns a screenshot of the screen region defined by `rect`. Returns
`null` if `rect` is outside screen bounds or the **DisplayServer** fails
to capture screenshot.

\*\*Note:\*\* This method is implemented on macOS and Windows. On other
platforms, this method always returns `null`.
...
role="ref"}. Returns
`SCREEN_LANDSCAPE<class_DisplayServer_constant_SCREEN_LANDSCAPE>`{.interpreted-text
role="ref"} if `screen` is invalid.
...
\*\*Note:\*\* This method is implemented on Android and iOS. On other
platforms, this method always returns
`SCREEN_LANDSCAPE<class_DisplayServer_constant_SCREEN_LANDSCAPE>`{.interpreted-text
role="ref"}.
...
\*\*Note:\*\* This method is implemented on Linux (X11, excluding
XWayland), macOS, and Windows. On other platforms, this method always
returns `Color<class_Color>`{.interpreted-text role="ref"}.

\*\*Note:\*\* On macOS, this method requires the \"Screen Recording\"
permission. If permission is not granted, this method returns a
screenshot that will only contain the desktop wallpaper, the current
application\'s window, and other related UI elements.
...
Returns the screen\'s top-left corner position in pixels. Returns
`Vector2i.ZERO<class_Vector2i_constant_ZERO>`{.interpreted-text
role="ref"} if `screen` is invalid. On multi-monitor setups, the screen
position is relative to the virtual desktop area. On multi-monitor
setups with different screen resolutions or orientations, the origin
might be located outside any display like this:
...
Returns the current refresh rate of the specified screen. Returns `-1.0`
if `screen` is invalid or the **DisplayServer** fails to find the
refresh rate for the specified screen.
...
\*\*Note:\*\* This method is implemented on Android, iOS, macOS, Linux
(X11 and Wayland), and Windows. On other platforms, this method always
returns `-1.0`.
...
Returns the scale factor of the specified screen by index. Returns `1.0`
if `screen` is invalid.
...
\*\*Note:\*\* This method is implemented on Android, iOS, Web, macOS,
and Linux (Wayland). On other platforms, this method always returns
`1.0`.
...
\*\*Note:\*\* This method is implemented on Linux/X11, macOS, and
Windows. On other platforms, this method always returns
`Rect2i(screen_get_position(screen), screen_get_size(screen))`.
...
:::: {#class_DisplayServer_method_set_hardware_keyboard_connection_change_callback}
::: rst-class
classref-method
:::
::::
...
`Callable<class_Callable>`{.interpreted-text role="ref"})
`🔗<class_DisplayServer_method_set_hardware_keyboard_connection_change_callback>`{.interpreted-text
role="ref"}

Sets the `callable` that should be called when hardware keyboard is
connected/disconnected. `callable` should accept a single
`bool<class_bool>`{.interpreted-text role="ref"} parameter indicating
whether the keyboard is connected (true) or disconnected (false).
...
:::: {#class_DisplayServer_method_show_emoji_and_symbol_picker}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_DisplayServer_method_show_emoji_and_symbol_picker>`{.interpreted-text
role="ref"}
...
\*\*Note:\*\* On Android 7 and 8, the keyboard height may return 0 the
first time the keyboard is opened in non-immersive mode. This behavior
does not occur in immersive mode.
...
role="ref"}. Returns
`INVALID_SCREEN<class_DisplayServer_constant_INVALID_SCREEN>`{.interpreted-text
role="ref"} if `window_id` is invalid.
...
:::: {#class_DisplayServer_method_window_start_drag}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**window_start_drag**(window_id: `int<class_int>`{.interpreted-text
role="ref"} = 0)
`🔗<class_DisplayServer_method_window_start_drag>`{.interpreted-text
role="ref"}

Starts an interactive drag operation on the window with the given
`window_id`, using the current mouse position. Call this method when
handling a mouse button being pressed to simulate a pressed event on the
window\'s title bar. Using this method allows the window to participate
in space switching, tiling, and other system features.
...
:::: {#class_DisplayServer_method_window_start_resize}
::: rst-class
classref-method
:::
::::
...
`void (No return value.)`{.interpreted-text role="abbr"}
**window_start_resize**(edge:
`WindowResizeEdge<enum_DisplayServer_WindowResizeEdge>`{.interpreted-text
role="ref"}, window_id: `int<class_int>`{.interpreted-text role="ref"} =
0)
`🔗<class_DisplayServer_method_window_start_resize>`{.interpreted-text
role="ref"}
