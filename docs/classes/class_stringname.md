...
`find()<class_StringName_method_find>`{.interpreted-text role="ref"}.
See also
`containsn()<class_StringName_method_containsn>`{.interpreted-text
role="ref"}.
...
`length()<class_StringName_method_length>`{.interpreted-text
role="ref"}.
...
`to_int()<class_StringName_method_to_int>`{.interpreted-text
role="ref"}.
...
of `split()<class_StringName_method_split>`{.interpreted-text
role="ref"}.
...
beginning. See also
`rstrip()<class_StringName_method_rstrip>`{.interpreted-text
role="ref"}.
...
:::: {#class_StringName_method_remove_char}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"} `🔗<class_StringName_method_remove_char>`{.interpreted-text
role="ref"}

Removes all occurrences of the Unicode character with code `what`.
Faster version of
`replace()<class_StringName_method_replace>`{.interpreted-text
role="ref"} when the key is only one character long and the replacement
is `""`.
...
:::: {#class_StringName_method_remove_chars}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_StringName_method_remove_chars>`{.interpreted-text role="ref"}

Removes any occurrence of the characters in `chars`. See also
`remove_char()<class_StringName_method_remove_char>`{.interpreted-text
role="ref"}.
...
:::: {#class_StringName_method_replace_char}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_StringName_method_replace_char>`{.interpreted-text role="ref"}
...
`replace()<class_StringName_method_replace>`{.interpreted-text
role="ref"} when the key is only one character long. To get a single
character use `"X".unicode_at(0)` (note that some strings, like compound
letters and emoji, can be composed of multiple unicode codepoints, and
will not work with this method, use
...
:::: {#class_StringName_method_replace_chars}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_StringName_method_replace_chars>`{.interpreted-text
role="ref"}

Replaces any occurrence of the characters in `keys` with the Unicode
character with code `with`. See also
`replace_char()<class_StringName_method_replace_char>`{.interpreted-text
role="ref"}.
...
:::: {#class_StringName_method_to_kebab_case}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_StringName_method_to_kebab_case>`{.interpreted-text
role="ref"}
...
:::: {#class_StringName_method_to_multibyte_char_buffer}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_StringName_method_to_multibyte_char_buffer>`{.interpreted-text
role="ref"}
...
See also `String.chr()<class_String_method_chr>`{.interpreted-text
role="ref"},
...
See also
`uri_encode()<class_StringName_method_uri_encode>`{.interpreted-text
role="ref"}.
...
See also
`uri_decode()<class_StringName_method_uri_decode>`{.interpreted-text
role="ref"}.
...
:::: {#class_StringName_method_uri_file_decode}
::: rst-class
classref-method
:::
::::
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_StringName_method_uri_file_decode>`{.interpreted-text
role="ref"}
