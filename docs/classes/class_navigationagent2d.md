...
`waypoint_reached<class_NavigationAgent2D_signal_waypoint_reached>`{.interpreted-text
...
`🔗<class_NavigationAgent2D_property_path_return_max_length>`{.interpreted-text
role="ref"}
...
`🔗<class_NavigationAgent2D_property_path_return_max_radius>`{.interpreted-text
role="ref"}
...
radius. Compared to
`path_return_max_length<class_NavigationAgent2D_property_path_return_max_length>`{.interpreted-text
...
`🔗<class_NavigationAgent2D_property_path_search_max_distance>`{.interpreted-text
role="ref"}
...
`🔗<class_NavigationAgent2D_property_path_search_max_polygons>`{.interpreted-text
role="ref"}
...
`NavigationPolygon.agent_radius<class_NavigationPolygon_property_agent_radius>`{.interpreted-text
...
`const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text
role="abbr"}
`🔗<class_NavigationAgent2D_method_get_path_length>`{.interpreted-text
role="ref"}
