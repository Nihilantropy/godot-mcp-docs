...
size, use `abs()<class_Rect2i_method_abs>`{.interpreted-text
role="ref"}.
...
`get_area()<class_Rect2i_method_get_area>`{.interpreted-text
role="ref"}.
...
the edges. See also
`encloses()<class_Rect2i_method_encloses>`{.interpreted-text
role="ref"}.
