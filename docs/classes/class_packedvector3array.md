...
:::: {#class_PackedVector3Array_method_erase}
::: rst-class
classref-method
:::
::::
...
`Vector3<class_Vector3>`{.interpreted-text role="ref"})
`🔗<class_PackedVector3Array_method_erase>`{.interpreted-text
role="ref"}
...
`remove_at()<class_PackedVector3Array_method_remove_at>`{.interpreted-text
role="ref"} instead.
...
this method fails and returns `Vector3(0, 0, 0)`.
...
`size()<class_PackedVector3Array_method_size>`{.interpreted-text
