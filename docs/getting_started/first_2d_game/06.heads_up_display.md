# Heads up display {#doc_your_first_2d_game_heads_up_display}
...
func [on_start_button_pressed]{#on_start_button_pressed}():

:   \$StartButton.hide() start_game.emit()

func [on_message_timer_timeout]{#on_message_timer_timeout}():
...
var hud = GetNode\<HUD\>(\"HUD\"); hud.UpdateScore([score]{#score});
...
GetNode\<HUD\>(\"HUD\").UpdateScore([score]{#score});
::::
