# Setting up the project {#doc_your_first_2d_game_project_setup}
...
`doc_c_sharp_setup`{.interpreted-text role="ref"}.
...
of the game window. Click on *Project -\> Project Settings* to open the
project settings window, in the left column open the *Display -\>
Window* tab. There, set \"Viewport Width\" to `480` and \"Viewport
Height\" to `720`. You can see the \"Project\" menu on the upper left
corner.
