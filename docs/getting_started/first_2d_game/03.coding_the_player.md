# Coding the player {#doc_your_first_2d_game_coding_the_player}
...
public override void [Ready]{#ready}() { ScreenSize =
...
public override void [Process]{#process}(double delta) { var velocity =
...
func [on_body_entered]{#on_body_entered}([body]{#body}):
