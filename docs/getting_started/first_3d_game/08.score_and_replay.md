# Score and replay {#doc_first_3d_game_score_and_replay}
...
public partial class ScoreLabel : Label { private int [score]{#score} =
0; }
::::
...
func [on_mob_squashed]{#on_mob_squashed}():
...
public void OnMobSquashed() { [score]{#score} += 1; Text = \$\"Score:
{[score]{#score}}\"; }
::::
...
\@event) { if (@event.IsActionPressed(\"ui_accept\") &&
