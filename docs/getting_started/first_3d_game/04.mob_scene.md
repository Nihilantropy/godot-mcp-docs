# Designing the mob scene {#doc_first_3d_game_designing_the_mob_scene}
...
languages like C# or Lua. GDScript uses a different technique to manage
memory, reference counting, which doesn\'t have that caveat. You can
