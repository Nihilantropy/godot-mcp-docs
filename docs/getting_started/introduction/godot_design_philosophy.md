# Godot\'s design philosophy {#doc_godot_design_philosophy}
...
All technologies that ship with Godot, including third-party libraries,
must be legally compatible with this open source license. Therefore,
most parts of Godot are developed from the ground up by community
contributors.
...
<figcaption>RPG in a Box is a voxel RPG editor made with Godot. It uses
Godot's UI tools for its node-based programming system and for the rest
of the interface.</figcaption>
</figure>
