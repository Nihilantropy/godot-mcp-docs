# Learning new features {#doc_learning_new_features}
...
official [Godot Forum](https://forum.godotengine.org/). These responses
show up in search engine results and get saved, allowing other users to
benefit from discussions on the platform. Once you have asked a question
there, you can share its link on other social platforms. Before asking a
question, be sure to look for existing answers that might solve your
problem on this website or using your preferred search engine.
...
4.  **Share a screenshot** of your *Scene* dock along with your written
    ...
    [Flameshot](https://flameshot.org/) on Windows/macOS/Linux.
