# Using C++ profilers {#doc_using_cpp_profilers}
...
role="ref"} in the editor, but using C++ profiler may be useful in cases
where the GDScript profiler is not accurate enough or is missing
