# Validation layers {#doc_vulkan_validation_layers}
...
If testing validation layers on an exported project, you must recompile
the export template and specify it as a custom export template in your
project\'s macOS export preset.
::::
