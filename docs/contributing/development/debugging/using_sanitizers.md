...
Rebooting your machine will also revert the ASLR state to its default
values.

It\'s important to revert the changes as soon as possible because
lowering the ASLR entropy or disabling ASLR entirely can be a security
risk.
::::
