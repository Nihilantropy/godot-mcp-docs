...
using Visual Studio Code as a C# or GDScript editor. To code C# or
...
:   \"name\": \"Launch Project\", \"type\": \"lldb\", \"request\":
    \"launch\", \"program\":
    \"\${workspaceFolder}/bin/godot.macos.editor.x86_64\", // Change the
    arguments below for the project you want to test with. // To run the
    project instead of editing it, remove the \"\--editor\" argument.
    \"args\": \[\"\--editor\", \"\--path\",
    \"path-to-your-godot-project-folder\"\], \"cwd\":
    \"\${workspaceFolder}\", \"preLaunchTask\": \"build\"
...
:   \"name\": \"Launch Project\", \"type\": \"lldb\", \"request\":
    \"launch\", \"program\":
    \"\${workspaceFolder}/bin/godot.macos.editor.arm64\", // Change the
    arguments below for the project you want to test with. // To run the
    project instead of editing it, remove the \"\--editor\" argument.
    \"args\": \[\"\--editor\", \"\--path\",
    \"path-to-your-godot-project-folder\"\], \"cwd\":
...
is installed for configurations using [lldb]{.title-ref}.
