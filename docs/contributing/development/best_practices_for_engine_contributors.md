...
*\"Future proofing\"* and it\'s characterized by lines of thought such
as:
...
beings who design software) to actually understand all future user
...
A common reason for wanting to do this is that it\'s usually less code
