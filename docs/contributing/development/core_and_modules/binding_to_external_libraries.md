# Binding to external libraries {#doc_binding_to_external_libraries}
...
you should not use submodules. If your module doesn\'t get merged in,
you can always try to implement the external library as a GDExtension.
::::
