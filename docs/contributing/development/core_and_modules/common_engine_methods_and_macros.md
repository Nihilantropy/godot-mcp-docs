# Common engine methods and macros {#doc_common_engine_methods_and_macros}
...
You may have to `#include "core/os/time.h"` if it\'s not present
already.
...
## Error macros {#doc_common_engine_methods_and_macros_error_macros}
