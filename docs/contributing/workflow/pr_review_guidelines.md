# Pull request review process {#doc_pr_review_guidelines}
...
It should be clear [why]{#why}\_ a pull request is needed before it is
...
Here are some things to think about and look out for as you review the
code:
